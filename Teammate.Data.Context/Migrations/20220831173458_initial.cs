  ...
  public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeammateUser", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TeammateUser_AspNetUsers_AccountFID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SportType_SportCategory_CategoryFID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Message_TeammateUser_RecipientFID",
                        column: x => x.RecipientFID,
                        principalTable: "TeammateUser",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Message_TeammateUser_SenderFID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceStart = table.Column<double>(type: "float", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SportLookup", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SportLookup_LookupCategory_LookupCategoryFID",
                        column: x => x.LookupCategoryFID,
                        principalTable: "LookupCategory",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SportLookup_SportType_SportTypeFID",
                        column: x => x.SportTypeFID,
                        principalTable: "SportType",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SportLookup_TeammateUser_UserFID",
                        column: x => x.UserFID,
                        principalTable: "TeammateUser",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Message_RecipientFID",
                table: "Message",
                column: "RecipientFID");

            migrationBuilder.CreateIndex(
                name: "IX_Message_SenderFID",
                table: "Message",
                column: "SenderFID");

            migrationBuilder.CreateIndex(
                name: "IX_SportLookup_LookupCategoryFID",
                table: "SportLookup",
                column: "LookupCategoryFID");

            migrationBuilder.CreateIndex(
                name: "IX_SportLookup_SportTypeFID",
                table: "SportLookup",
                column: "SportTypeFID");

            migrationBuilder.CreateIndex(
                name: "IX_SportLookup_UserFID",
                table: "SportLookup",
                column: "UserFID");

            migrationBuilder.CreateIndex(
                name: "IX_SportType_CategoryFID",
                table: "SportType",
                column: "CategoryFID");

            migrationBuilder.CreateIndex(
                name: "IX_TeammateUser_AccountFID",
                table: "TeammateUser",
                column: "AccountFID",
                unique: true);
        }
